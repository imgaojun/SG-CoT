...
OUT = REPO / "configs/generated/stage2_adaptive/richere_qwen3_1_7b_adaptive_outcome_calibrated_sharedbase_fix_formal_manifest.json"
...
def main():
    ...
    for branch in BRANCHES:
        ...
        runs.append(
            {
                "tag": f"{branch}__sharedbase_fix_execution_gate",
