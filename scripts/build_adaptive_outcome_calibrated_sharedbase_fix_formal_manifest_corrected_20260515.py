...
FORMAL_ROOT = "outputs/stage2_adaptive_runs_user_formal_corrected"
SELECTION_ROOT = "outputs/stage2_adaptive_runs_user_devpick_frontier/protocol_selections"
OUT = REPO / "configs/generated/stage2_adaptive/richere_qwen3_1_7b_adaptive_outcome_calibrated_sharedbase_fix_formal_manifest_corrected_20260515.json"
...
def eval_spec(branch: str, mode: str, split: str):
    ...
    return {
        ...
        "output_dir": f"{FORMAL_ROOT}/richere_split1_qwen3_1_7b_adaptive_{branch}/sharedbase_fix_execution_gate/{mode}/{split}",
    }
...
def main():
    ...
    for branch in BRANCHES:
        selection = f"{SELECTION_ROOT}/{branch}__sharedbase_fix_execution_gate/selection_summary.json"
        ...
        if not gate_passed(selection_path):
            skipped.append({"branch": branch, "reason": "sharedbase_fix_execution_gate_failed"})
            continue
        runs.append(
            {
                "tag": f"{branch}__sharedbase_fix_execution_gate_corrected_20260515",
