...
expected = {
    ...
    "route_only_count": 3520,
    "route_only_classifier_prompt_count": 3520,
    "route_only_full_extraction_prompt_count": 0,
    "route_only_direct_rows": 1760,
    "route_only_reason_rows": 1760,
}
...
python3 scripts/prepare_adaptive_outcome_helpful_sharedbase_balanced_routeaux_20260515.py
