...
LOG_ROOT="outputs/stage2_1_7b_explicit_reason_forms/e21_logs_20260525"
DEVPICK_ROOT="outputs/stage2_1_7b_explicit_reason_forms/e21_devpick_20260525"
FORMAL_ROOT="outputs/stage2_1_7b_explicit_reason_forms/e21_formal_20260525"
...
branch_for() {
  case "$1" in
    e21a) echo "eventmentions_budget_e21a_explicit_forms" ;;
...
budgets_for() {
  case "$1" in
    e21a) echo "none light standard deep" ;;
    *) echo "unknown variant: $1" >&2; exit 2 ;;
  esac
}
...
train_one() {
  local variant="$1"
  local gpu="$2"
  local name="stage2_1_7b_${variant}_explicit_reason_forms_train_20260525"
...
devpick_one() {
  local variant="$1"
  local gpu="$2"
  local name="stage2_1_7b_${variant}_explicit_reason_forms_devpick_20260525"
  if docker ps -a --format '{{.Names}}' | grep -Fxq "${name}"; then
    echo "container already exists: ${name}" >&2
    return 0
  fi
...
eval_one() {
  ...
  local name="stage2_1_7b_${variant}_explicit_reason_forms_forced_${budget}_${split}_20260525"
