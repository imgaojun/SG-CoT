...
LOG_ROOT="outputs/stage2_1_7b_reason_budget/e20_logs_20260524"
DEVPICK_ROOT="outputs/stage2_1_7b_reason_budget/e20_devpick_20260524"
FORMAL_ROOT="outputs/stage2_1_7b_reason_budget/e20_formal_20260524"
...
branch_for() {
  case "$1" in
    e20a) echo "eventmentions_budget_e20a_weighted_standard_cxop" ;;
    e20b) echo "eventmentions_budget_e20b_multibudget_profile" ;;
...
budgets_for() {
  case "$1" in
    e20a) echo "none standard" ;;
    e20b) echo "none light standard deep" ;;
    *) echo "unknown variant: $1" >&2; exit 2 ;;
  esac
}
...
train_one() {
  local variant="$1"
  local gpu="$2"
  local name="stage2_1_7b_${variant}_reason_budget_train_20260524"
...
devpick_one() {
  local variant="$1"
  local gpu="$2"
  local name="stage2_1_7b_${variant}_reason_budget_devpick_20260524"
  if docker ps -a --format '{{.Names}}' | grep -Fxq "${name}"; then
    echo "container already exists: ${name}" >&2
    return 0
  fi
...
eval_one() {
  ...
  local name="stage2_1_7b_${variant}_reason_budget_forced_${budget}_${split}_20260524"
