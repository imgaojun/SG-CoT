...
LOG_ROOT="outputs/stage2_1_7b_reason_lightweight/e24_e25_logs_20260526"
DEVPICK_ROOT="outputs/stage2_1_7b_reason_lightweight/e24_e25_devpick_20260526"
FORMAL_ROOT="outputs/stage2_1_7b_reason_lightweight/e24_e25_formal_20260526"
...
branch_for() {
  case "$1" in
    e24a) echo "eventmentions_budget_e24a_lite_standard" ;;
    e25a) echo "eventmentions_budget_e25a_final_first_weakreason" ;;
...
budgets_for() {
  case "$1" in
    e24a|e25a) echo "none light standard deep" ;;
    *) echo "unknown variant: $1" >&2; exit 2 ;;
  esac
}
...
train_one() {
  local variant="$1"
  local gpu="$2"
  local name="stage2_1_7b_${variant}_reason_lightweight_train_20260526"
...
devpick_one() {
  local variant="$1"
  local gpu="$2"
  local name="stage2_1_7b_${variant}_reason_lightweight_devpick_20260526"
  if docker ps -a --format '{{.Names}}' | grep -Fxq "${name}"; then
    echo "container already exists: ${name}" >&2
    return 0
  fi
...
eval_one() {
  ...
  local name="stage2_1_7b_${variant}_reason_lightweight_forced_${budget}_${split}_20260526"
