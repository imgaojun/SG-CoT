...
ADAPTER="outputs/stage2_adaptive_runs_user/${RUN_PREFIX}_${BRANCH}_full/checkpoint-504"
DATA_BASE="data/stage2_adaptive_datasets/richere_balanced_split1_oracle_mixed_noise_top10_shuffle_adaptive"
LOG_ROOT="outputs/stage2_4b_strong_reason_supervision/e18_ckpt504_logs_20260523"
FORMAL_ROOT="outputs/stage2_4b_strong_reason_supervision/e18_ckpt504_formal_20260523"
...
eval_one() {
  ...
  local name="stage2_4b_e18a_ckpt504_${mode}_${split}_20260523"
...
case "${1:-}" in
  formal)
    ...
    ;;
  *)
    echo "usage: $0 formal [gpu0 gpu1 gpu2 gpu3]" >&2
    exit 2
    ;;
esac
