...
ANCHOR_CKPTS="checkpoint-142 checkpoint-284 checkpoint-426 checkpoint-568 checkpoint-710 checkpoint-852 checkpoint-994 checkpoint-1136 checkpoint-1278 checkpoint-1420 checkpoint-1562 checkpoint-1704 checkpoint-1846 checkpoint-1988 checkpoint-2130 checkpoint-2272"

launch_branch() {
  local branch="$1"
  local host_gpus="$2"
  local ckpts="$3"
  local name="adaptive_hint_${branch}_devpick_20260510"
...
launch_branch "confrare10_heur10_type_role_hint_plan_lite" "0,1" "${COMMON_CKPTS}"
launch_branch "confrare5_heur5_type_role_hint_plan_lite" "2,3" "${COMMON_CKPTS}"
launch_branch "confrare10_heur10_type_role_hint_plan_lite_pairdirect" "4,5" "${ANCHOR_CKPTS}"
launch_branch "confrare10_heur10_type_role_hint_plan_lite_directanchor" "6,7" "${ANCHOR_CKPTS}"
