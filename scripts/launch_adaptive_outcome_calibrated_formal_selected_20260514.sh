...
CONTAINER_NAME="richere_qwen3_adaptive_outcome_calibrated_formal_selected_20260514"
...
STATUS="outputs/stage2_adaptive_runs_user_formal_clean/richere_qwen3_1_7b_adaptive_outcome_calibrated_execution_gate_formal_status.json"
LOG="outputs/stage2_adaptive_runs_user_logs/richere_qwen3_1_7b_adaptive_outcome_calibrated_execution_gate_formal.log"
