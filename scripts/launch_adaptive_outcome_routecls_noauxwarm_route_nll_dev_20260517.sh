...
SCORE_ROOT="outputs/stage2_adaptive_route_likelihood_probe/routecls_noauxwarm_20260517"
LOG_DIR="outputs/stage2_adaptive_runs_user_logs"

launch_branch() {
  local branch="$1"
  local host_gpu="$2"
  local name="adaptive_outcome_routecls_noauxwarm_route_nll_${branch}_20260517"
  ...
  local log="${LOG_DIR}/adaptive_outcome_routecls_noauxwarm_route_nll_${branch}_20260517.log"
