...
VARIANT="${2:-e63a}"
case "${VARIANT}" in
  e63a|completeness_granularity)
    BRANCH="e63a_completeness_granularity_glm51_seed1500_thinking_evidence_cot"
    LABEL="e63a_completeness_granularity"
    ;;
  e63b|completeness_granularity_light_evidence)
    BRANCH="e63b_completeness_granularity_light_evidence_glm51_seed1500_thinking_evidence_cot"
    LABEL="e63b_completeness_granularity_light_evidence"
    ;;
  *)
...
OUT_BASE="outputs/stage2_strategy_cot_e63/${LABEL}_qwen4_20260608"
...
case "${1:-}" in
  ...
  eval)
    ...
    ;;
  *)
    echo "usage: $0 train <e63a|e63b> [gpu] | eval <e63a|e63b> <ckpt> [gpu]" >&2
    exit 2
    ;;
esac
