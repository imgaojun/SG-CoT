...
VARIANT="${2:-e64a}"
case "${VARIANT}" in
  e64a|e57_backbone_role_grounding)
    BRANCH="e64a_e57_backbone_role_grounding_glm51_seed1500_thinking_evidence_cot"
    LABEL="e64a_e57_backbone_role_grounding"
    ;;
  e64b|e57_backbone_event_frame_lock)
    BRANCH="e64b_e57_backbone_event_frame_lock_glm51_seed1500_thinking_evidence_cot"
    LABEL="e64b_e57_backbone_event_frame_lock"
    ;;
  *)
...
OUT_BASE="outputs/stage2_strategy_cot_e64/${LABEL}_qwen4_20260608"
...
case "${1:-}" in
  ...
  eval)
    ...
    ;;
  *)
    echo "usage: $0 train <e64a|e64b> [gpu] | eval <e64a|e64b> <ckpt> [gpu]" >&2
    exit 2
    ;;
esac
