...
BRANCH="aet_rankstable_router_m04b_routecls_noauxwarm_lr2e6_save50"
RUN_DIR="outputs/stage2_adaptive_runs_user/${RUN_PREFIX}_${BRANCH}_full"
SCORE_ROOT="outputs/stage2_modular_dualexpert/aet_rankstable_router_m04b_20260520/formal_route_likelihood/${BRANCH}"
...
launch_score() {
  ...
  local split="$2"
  local host_gpu="$3"
  local name="modular_dualexpert_aet_rankstable_m04b_formal_nll_${ckpt}_${split}_20260520"
  ...
  local log="${LOG_DIR}/modular_dualexpert_aet_rankstable_m04b_formal_nll_${ckpt}_${split}_20260520.log"
