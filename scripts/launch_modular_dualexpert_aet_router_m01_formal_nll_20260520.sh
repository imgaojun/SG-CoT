...
SCORE_ROOT="outputs/stage2_modular_dualexpert/aet_router_m01_20260520/formal_route_likelihood"
...
launch_score() {
  ...
  local split="$3"
  local host_gpu="$4"
  local name="modular_dualexpert_aet_router_m01_formal_nll_${branch}_${ckpt}_${split}_20260520"
  ...
  local output_dir="${SCORE_ROOT}/${branch}/${ckpt}/${split}"
  local log="${LOG_DIR}/modular_dualexpert_aet_router_m01_formal_nll_${branch}_${ckpt}_${split}_20260520.log"
...
case "${1:-}" in
  launch)
    launch_score aet_safe_router_m01_routecls_noauxwarm_lr2e6_save50 checkpoint-250 test_seen 0
    launch_score aet_safe_router_m01_routecls_noauxwarm_lr2e6_save50 checkpoint-250 test_unseen 1
    launch_score aet_event_router_m01_routecls_noauxwarm_lr2e6_save50 checkpoint-50 test_seen 2
    launch_score aet_event_router_m01_routecls_noauxwarm_lr2e6_save50 checkpoint-50 test_unseen 3
    ;;
  *)
