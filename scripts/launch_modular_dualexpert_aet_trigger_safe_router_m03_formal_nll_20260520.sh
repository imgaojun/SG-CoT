...
BRANCH="aet_trigger_safe_router_m03_routecls_noauxwarm_lr2e6_save50"
RUN_DIR="outputs/stage2_adaptive_runs_user/${RUN_PREFIX}_${BRANCH}_full"
SCORE_ROOT="outputs/stage2_modular_dualexpert/aet_trigger_safe_router_m03_20260520/formal_route_likelihood/${BRANCH}"
...
launch_score() {
  ...
  local split="$2"
  local host_gpu="$3"
  local name="modular_dualexpert_aet_trigger_safe_m03_formal_nll_${ckpt}_${split}_20260520"
  ...
  local log="${LOG_DIR}/modular_dualexpert_aet_trigger_safe_m03_formal_nll_${ckpt}_${split}_20260520.log"
