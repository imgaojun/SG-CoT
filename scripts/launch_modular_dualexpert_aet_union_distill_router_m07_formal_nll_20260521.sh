...
SCORE_ROOT="outputs/stage2_modular_dualexpert/aet_union_distill_router_m07_20260521/formal_route_likelihood/${BRANCH}"
...
launch_score() {
  ...
  local split="$2"
  local host_gpu="$3"
  local name="modular_dualexpert_aet_m07_formal_nll_${ckpt}_${split}_20260521"
  ...
  local log="${LOG_DIR}/modular_dualexpert_aet_m07_formal_nll_${ckpt}_${split}_20260521.log"
