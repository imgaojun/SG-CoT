...
SCORE_ROOT="outputs/stage2_modular_dualexpert/utility_router_m02_20260520/formal_route_likelihood/${BRANCH}"
...
launch_score() {
  ...
  local split="$2"
  local host_gpu="$3"
  local name="modular_dualexpert_m02_rank_window_formal_nll_${ckpt}_${split}_20260520"
  ...
  local log="${LOG_DIR}/modular_dualexpert_m02_rank_window_formal_nll_${ckpt}_${split}_20260520.log"
...
case "${1:-}" in
  launch)
    launch_score checkpoint-50 test_seen 4
    launch_score checkpoint-50 test_unseen 7
    launch_score checkpoint-100 test_seen 0
    launch_score checkpoint-100 test_unseen 1
    launch_score checkpoint-150 test_seen 2
    launch_score checkpoint-150 test_unseen 3
    launch_score checkpoint-200 test_seen 0
    launch_score checkpoint-200 test_unseen 1
    ;;
  *)
