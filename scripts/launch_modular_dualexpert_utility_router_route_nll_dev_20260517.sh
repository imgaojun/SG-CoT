...
SCORE_ROOT="${SCORE_ROOT:-outputs/stage2_modular_dualexpert/utility_router_gainpos_20260517/route_likelihood}"
LOG_DIR="outputs/stage2_adaptive_runs_user_logs"

launch_branch() {
  local branch="$1"
  local host_gpu="$2"
  local name="modular_dualexpert_utility_router_route_nll_${branch}_20260517"
  ...
  local log="${LOG_DIR}/modular_dualexpert_utility_router_route_nll_${branch}_20260517.log"
