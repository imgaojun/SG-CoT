...
launch_branch() {
  local branch="$1"
  local host_gpu="$2"
  local name="modular_dualexpert_utility_router_route_nll_margin05_${branch}_20260517"
  ...
  local log="${LOG_DIR}/modular_dualexpert_utility_router_route_nll_margin05_${branch}_20260517.log"
