...
# ACE05 dataset-family overrides
...
if [ "${LIMIT}" -lt 50 ]; then
  RUN_NAME="e83_ace05_trigger_locked_schema_driven_glm51_smoke${LIMIT}"
  OUT_DIR="outputs/stage2_strategy_cot_e83/ace05_e83_trigger_locked_schema_driven_glm51_smoke${LIMIT}_20260617"
else
  RUN_NAME="e83_ace05_trigger_locked_schema_driven_glm51_full1500"
  OUT_DIR="outputs/stage2_strategy_cot_e83/ace05_e83_trigger_locked_schema_driven_glm51_full1500_20260617"
fi
...
# Build the contrastive manifest from the ACE05 train pool (RichERE-tuned buckets degrade gracefully).
