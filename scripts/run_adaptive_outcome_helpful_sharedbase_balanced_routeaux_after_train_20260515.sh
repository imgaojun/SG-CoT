...
LOG="outputs/stage2_adaptive_runs_user_logs/adaptive_outcome_helpful_sharedbase_balanced_routeaux_after_train_20260515.log"
...
date '+[%F %T] balanced route-aux dev pipeline complete' | tee -a "${LOG}"
