...
SEEDS="${SEEDS:-21 22}"
RUN_SUFFIX="${RUN_SUFFIX:-_locked_seedpair21_22}"
...
FORMAL_DATASET_ID="${FORMAL_DATASET_ID:-sampled_k2_formal_locked_guard_seedpair21_22_20260519}"
EXPERIMENT_ID="${EXPERIMENT_ID:-sampled_k2_formal_locked_guard_seedpair21_22_20260519}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/stage2_adaptive_route_formal_nll_locked_guard_seedpair21_22_20260519/${BRANCH}}"
CONFIG_PATH="${CONFIG_PATH:-configs/generated/stage2_adaptive/sampledk2_formal_locked_guard_seedpair21_22_20260519.json}"
REPORT_PATH="${REPORT_PATH:-reports/2026-05-19_stage2_sampled_k2_formal_locked_guard_seedpair21_22_validation.md}"
...
python3 scripts/summarize_sampled_k2_formal_locked_guard_validation_20260519.py \
  --seeds ${SEEDS} \
  --sample-root "${SAMPLE_ROOT}" \
  --nll-root "${OUTPUT_ROOT}" \
