...
SEEDS="${SEEDS:-25 26}"
RUN_SUFFIX="${RUN_SUFFIX:-_margin_budget_seedpair25_26}"
...
FORMAL_DATASET_ID="${FORMAL_DATASET_ID:-sampled_k2_formal_margin_budget_seedpair25_26_20260520}"
EXPERIMENT_ID="${EXPERIMENT_ID:-sampled_k2_margin_budget_top15_seedpair25_26_20260520}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/stage2_adaptive_route_formal_nll_margin_budget_seedpair25_26_20260520/${BRANCH}}"
CONFIG_PATH="${CONFIG_PATH:-configs/generated/stage2_adaptive/sampledk2_formal_margin_budget_top15_seedpair25_26_20260520.json}"
REPORT_PATH="${REPORT_PATH:-reports/2026-05-20_stage2_locked_margin_budget_top15_seedpair25_26_validation.md}"
REPORT_JSON="${REPORT_JSON:-reports/artifacts/2026-05-20_stage2_locked_margin_budget_top15_seedpair25_26_validation.json}"
SUMMARY_ROOT="${SUMMARY_ROOT:-outputs/stage2_adaptive_route_formal_margin_budget_validation_20260520/seedpair25_26_top15}"
...
python3 scripts/summarize_sampled_k2_margin_budget_locked_validation_20260520.py \
  --seeds ${SEEDS} \
