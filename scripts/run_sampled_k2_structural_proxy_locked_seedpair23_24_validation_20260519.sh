...
SEEDS="${SEEDS:-23 24}"
RUN_SUFFIX="${RUN_SUFFIX:-_structural_seedpair23_24}"
...
FORMAL_DATASET_ID="${FORMAL_DATASET_ID:-sampled_k2_formal_structural_proxy_locked_seedpair23_24_20260519}"
EXPERIMENT_ID="${EXPERIMENT_ID:-sampled_k2_structural_proxy_locked_seedpair23_24_20260519}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/stage2_adaptive_route_formal_nll_structural_proxy_seedpair23_24_20260519/${BRANCH}}"
CONFIG_PATH="${CONFIG_PATH:-configs/generated/stage2_adaptive/sampledk2_formal_structural_proxy_locked_seedpair23_24_20260519.json}"
REPORT_PATH="${REPORT_PATH:-reports/2026-05-19_stage2_sampled_k2_structural_proxy_locked_seedpair23_24_validation.md}"
REPORT_JSON="${REPORT_JSON:-reports/artifacts/2026-05-19_stage2_sampled_k2_structural_proxy_locked_seedpair23_24_validation.json}"
SUMMARY_ROOT="${SUMMARY_ROOT:-outputs/stage2_adaptive_route_formal_structural_proxy_validation_20260519/seedpair23_24}"
...
python3 scripts/summarize_sampled_k2_structural_proxy_locked_validation_20260519.py \
  --seeds ${SEEDS} \
  --sample-root "${SAMPLE_ROOT}" \
  --fresh-nll-root "${OUTPUT_ROOT}" \
