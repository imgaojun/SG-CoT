...
FORMAL_ROOT = REPO / "outputs/stage2_1_7b_trigger_preserving_forms/e22_formal_20260526"
DEVPICK_ROOT = REPO / "outputs/stage2_1_7b_trigger_preserving_forms/e22_devpick_20260526"
OUT_JSON = REPO / "reports/artifacts/2026-05-26_stage2_1_7b_trigger_preserving_forms_e22.json"
OUT_MD = REPO / "reports/2026-05-26_stage2_1_7b_trigger_preserving_forms_e22.md"

VARIANTS = {
    "e22a_trigger_preserving_forms": {"variant": "e22a", "budgets": ["none", "light", "standard", "deep"]},
}
...
def render(payload):
    lines = [
        "# 1.7B Trigger-Preserving Reasoning Forms E22",
        "",
        "This report summarizes E22A, where standard/deep intermediate forms explicitly preserve trigger spans.",
        "",
    ]
    ...
    lines.extend(
        [
            "## Reading",
            "",
            "- E22 tests whether trigger-preserving intermediate forms reduce the small Trigger loss observed in E21A standard/deep.",
            "- A positive result should keep E21A's Argument/Event gains while improving Trigger relative to E21A standard.",
        ]
    )
    return "\n".join(lines) + "\n"
...
def main():
    ...
    payload = {
        ...
        "variants": VARIANTS,
        "dev_selection": [item for item in (load_dev_selection("e22a"),) if item],
        "results": rows,
