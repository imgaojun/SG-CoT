...
def render_instruction():
    return (
        ...
        "Do not repeat prompt text, schema text, or add any explanation outside the JSON object. "
...
def render_input(row, candidate_types, schema_by_type):
    ...
    return (
        ...
        "- Each plan contains `event_type` and `trigger`.\n"
        ...
        samples.append(
            {
                ...
                "meta": {
                    ...
                    "candidate_order_mode": candidate_order_mode,
                    "prompt_style": "noexample_minimal_cot_v1",
                    **dataset_meta,
                },
            }
        )
